...
flags.DEFINE_string("dataset_address", "./dataset/ped1_test_t8_splited/", "The path of dataset")
flags.DEFINE_string("input_fname_pattern", "*", "Glob pattern of filename of input images [*]")
flags.DEFINE_string("checkpoint_dir", "./checkpoint/ped1_seq_20_45_45/", "Directory name to save the checkpoints [checkpobuint]")

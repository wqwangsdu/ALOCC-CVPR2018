...
flags.DEFINE_float("r_alpha", 10, "Refinement parameter [0.2]")
flags.DEFINE_float("train_size", np.inf, "The size of train images [np.inf]")
flags.DEFINE_integer("batch_size", 21, "The size of batch images [64]")
...
flags.DEFINE_string("dataset", "avenue", "The name of dataset [UCSD, mnist, ped1_seq, avenue]")
flags.DEFINE_string("dataset_address", "./dataset/AVENUE_t8_split", "The path of dataset")
